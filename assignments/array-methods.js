...
// Bring an array of the first names and combine them with an array of last names to form another array called fullNames
// The array we are referencing is called runners
let fullNames = [];
...
runners.map(function(runners){
  return firstNamesAllCaps.push (runners.first_name.toUpperCase()); 
});
...
// We need an array that is filled with shirt_size: "L" 
...
let ticketPriceTotal = runners.reduce(function(totalValue, runner) {
